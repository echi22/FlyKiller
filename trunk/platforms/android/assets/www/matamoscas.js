function Mosca(element,jqueryElement){
	...
	{
	return false;
		var currentTop=parseInt(_self.element.offsetTop);
		var currentLeft=parseInt(_self.element.offsetLeft);
	...
	this.die = function(){
		_self.isDead = true;
		var selfWidth = _self.element.offsetWidth;
		var selfHeight = _self.element.offsetHeight;
